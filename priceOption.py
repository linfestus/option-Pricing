...
def priceOption(strike,time,spotPrice,sigma,rateOfInterest,divident,numberOfTimeSteps,numberOfPriceSteps,optionType,option):
    ...
    while(True):
        ...
        if(optionType == "CALL"||optionType == "Call"||optionType == "call"):
    ...
    print (C[1][numberOfPriceSteps+1]+C[1][numberOfPriceSteps-1]-2*C[1][numberOfPriceSteps])/sigmaMax**2
